...
public class WorkerDeleteShowController
{
    @FXML
    ...
    public void initialize()
    {
        try
        {
            PreparedStatement pst = ConnectionVariable.c.prepareStatement("SELECT id_seans FROM bd_projekt.seans s, bd_projekt.kino k, bd_projekt.sala sl where s.id_sala = sl.id_sala and k.id_kino = sl.id_kino and k.id_kino = ?", ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
