...
public class AddActorController
{
    ...
    @FXML
    void addActorButton(ActionEvent event)
    {
        try
        {
            ...
            CallableStatement cst = ConnectionVariable.c.prepareCall("{call BD_projekt.getLastActorId()}");
            ResultSet rs = cst.executeQuery();
            rs.next();
            newId = 1 + rs.getInt(1);
            PreparedStatement pst = ConnectionVariable.c.prepareStatement("INSERT INTO BD_projekt.aktor VALUES (?, ?, ?)");
            pst.setInt(1, newId);
            ...
            Alert.alert1("pomyślnie dodano aktora");
            SwitchScene.switchScene(event, "adminPanel.fxml");
        }
